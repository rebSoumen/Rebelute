...
<div class='cost_calc_checkout_form clearfix'>
    ...
    <!--Start Form-->
    <form ACTION="https://www.paypal.com/cgi-bin/webscr" METHOD="POST" target="_parent" id='paypal_form' name="paypal_form" onsubmit="return validate();">   

        <!--Hidden fields-->
        <input TYPE="hidden" NAME="business" VALUE="sharmaparitosh7@gmail.com"> <!--Paypal business email-->
        ...
        <div class="cost_calc_summary clearfix">
            <label class="cost_calc_terms_checkbox">
                <input class="SV_validate_checkbox" id="terms" type="checkbox">
		...
		$.ajax({
			...
			success:function(data)
			{
				if(data==1)
				{
					...
					$("#paypal_div").show();
					$('html,body').animate({
					   scrollTop: $("#paypal_div").offset().top},
					   2000);
