                 ...
                 <h1 >Subscribers List</h1>
				  <?php if(isset($_GET['msg'])){
			       ...
			       <div class="alert alert-success">
                        <a class="close" data-dismiss="alert" onclick="ChangeUrl('Page1', '<?php echo base_url();?>admins/subscribers');" href="#">&times;</a> 
                            ...
                            <div class="box">
                                <header>
								   ...
								   <div class="toolbar">
                                        <ul class="nav">
                                            <li>
                                                <button type="button" onclick="window.location.href='<?php echo base_url();?>admins/exportSubscribers'" style="margin: 2px ! important;" class="btn btn-primary">Export  To Excel</button>
                                            </li>
                                        </ul>
                                    </div>
				   ...
				   /* $det_rec =  $admod->get_rec_id("category","cat_id",$rows->cat_f_id); */
									   ...
									   ?>
                                        <tr class="odd gradeX">
											...
											<td class="center">
											<a href="<?php echo base_url();?>admins/delete_subscribe/<?php echo $rows->subs_id	;?>" onclick="return confirm('Are you sure to delete');">Delete</a>
											</td>
										</tr>
									   <?php 
									          $i++;
