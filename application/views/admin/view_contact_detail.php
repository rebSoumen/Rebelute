<div class="content_wrapper">
        <div id="content">
                    ...
                    <div class="row">
						...
						<form action="#" class="form-horizontal" id="block-validate" enctype="multipart/form-data"  method="post">
						   ...
						   <div class="form-group">
							...
							<div class="form-group">
								<label class="control-label col-lg-3">Services </label>
								<div class="col-lg-4">
									<input type="text" name="phone" readonly value="<?php echo $data->services;?>" id="title" class="form-control"/>
									<br>
							...
							<div class="form-group">
								...
								<div class="col-lg-4">
									<input type="text" name="phone" readonly value="<?php echo $data->subject;?>" id="title" class="form-control"/>
									<br>
				...
				<div class="form-actions no-margin-bottom" style="text-align:center;">
					...
					<input type="button" onclick="window.location.href='<?php echo base_url();?>admins/contact_info'" value="Back " name="sub_hn" class="btn btn-primary btn-lg " />
