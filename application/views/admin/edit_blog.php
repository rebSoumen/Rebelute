...
<div class="content_wrapper">
        <div id="content">
						...
						<?php echo base_url();?>admins/save_edit_blog" class="form-horizontal" id="block-validate" enctype="multipart/form-data"  method="post">
                           ...
                           <div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-4">
									<input type="text" name="keywords"  id="keywords" value="<?php echo $data->keywords;?>" required class="form-control"/>
									<br>
				...
				<div class="form-actions no-margin-bottom" style="text-align:center;">
					...
					<input type="hidden" name="old_image_mobile" value="<?php echo $data->blog_image_mobile;?>"/>
