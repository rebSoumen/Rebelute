				 ...
				 if($_GET['msg']=='updated'){?>
			       ...
			       <div class="alert alert-success">
                    ...
                    <div class="row">
						...
						<form action="<?php echo base_url();?>admins/saveResource_pricinghourly" class="form-horizontal" id="block-validate" enctype="multipart/form-data"  method="post">
