                ...
                <div class="inner">
                 ...
                 <h1 >Edit Url Link</h1>
                    ...
                    <div class="row">
						...
						<form action="
						<?php echo base_url();?>admins/save_edit_url" class="form-horizontal" id="block-validate"  method="post">
						
						   <div class="form-group">
								<label class="control-label col-lg-3">Url Link</label>
								<div class="col-lg-4">
									<input type="text" name="url" value="<?php echo $data->url_link;?>" id="url" class="form-control"/>
									<br>
