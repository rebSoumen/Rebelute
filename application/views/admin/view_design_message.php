<div class="content_wrapper">
        <div id="content">
                ...
                <div class="inner">
                    <div class="row">
                    <div class="col-lg-12">
                 <h1>View Design Subscription Message</h1>
                            ...
                            <div class="box">
                                <header>
								   ...
								   <div class="toolbar">
                                        <ul class="nav">
                                            <li>
                                                <a href="<?php echo base_url();?>uploads/blogs/<?php echo $data->userfile;?>" download="<?php echo $data->userfile;?>"><button type="button" class="btn btn-primary"> Download User File </button></a>
                                            </li>
                                        </ul>
                                    </div>
				...
				<div class="form-actions no-margin-bottom" style="text-align:center;">
					...
					<input type="button" onclick="window.location.href='<?php echo base_url();?>admins/design_service_list'" value="Back " name="sub_hn" class="btn btn-primary btn-lg " />
