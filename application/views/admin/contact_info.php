                            ...
                            <div class="box">
                                <header>
								   ...
								   <div class="toolbar">
                                        <ul class="nav">
                                            <li>
                                                <button type="button" onclick="window.location.href='<?php echo base_url();?>admins/exportContactInfoToExcel'" style="margin: 2px ! important;" class="btn btn-primary">Export  To Excel</button>
                                            </li>
                                        </ul>
                                    </div>
				   ...
				   /* $det_rec =  $admod->get_rec_id("category","cat_id",$rows->cat_f_id); */
									   ...
									   ?>
                                        <tr class="odd gradeX">
											...
											<td class="center">
											<a href="<?php echo base_url();?>admins/view_contact_info/<?php echo $rows->contact_id;?>">View Message</a> |
											
											<a href="<?php echo base_url();?>admins/delete_contact_info/<?php echo $rows->contact_id;?>" onclick="return confirm('Are you sure to delete');">Delete</a>
											</td>
										</tr>
									   <?php 
									          $i++;
