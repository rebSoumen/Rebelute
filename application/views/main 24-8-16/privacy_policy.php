						...
						<div id="faqs" class="faqs">
							...
							<div id="faqs-list" class="fancy-title title-bottom-border">
								This privacy policy has been compiled to better serve those 
									...
									(PII) is being used online. PII, as used in US privacy 
									law and information security, is information that 
							...
							<h3 id="faq-1"> What personal information do we collect from the people that visit our blog, website or app?</h3>
							...
							<h3 id="faq-2">When do we collect information?</h3>
							<p>We collect information from you when you place an order, subscribe to a newsletter, respond to a survey, Open a Support Ticket or enter information on our site.
                            </p>

							<div class="divider divider-right"><a href="#" data-scrollto="#faqs-list"><i class="icon-chevron-up"></i></a></div>

							<h3 id="faq-3"> How do we use your information? </h3>
							<p>
							...
							<h3 id="faq-4">How do we protect visitor information?</h3>
							...
							<h3 id="faq-5">Do we use 'cookies'?</h3>
							...
							<p>You can choose to have your computer warn you each time a cookie is being sent, 
								  ...
								  your browser (like Internet Explorer) settings. Each browser is a little different,
							...
							<h3 id="faq-6">Third-party disclosure</h3>
							<p>We do not sell, trade, or otherwise transfer to outside parties your personally identifiable information.</p>

							<div class="divider divider-right"><a href="#" data-scrollto="#faqs-list"><i class="icon-chevron-up"></i></a></div>

							<h3 id="faq-7"> Third-party links</h3>
							<p>We do not include or offer third-party products or services on our website.</p>

							<div class="divider divider-right"><a href="#" data-scrollto="#faqs-list"><i class="icon-chevron-up"></i></a></div>

							<h3 id="faq-8">Google</h3>
							...
							<h3 id="faq-9">We have implemented the following:</h3>
							<ul>
							...
							<h3 id="faq-10">COPPA (Children Online Privacy Protection Act)</h3>
							<p>When it comes to the collection of personal information from children under 13, the Children's Online Privacy Protection Act (COPPA) puts parents in control. The Federal Trade Commission, the nation's consumer protection agency, enforces the COPPA Rule, which spells out what operators of websites and online services must do to protect children's privacy and safety online.</p>
							<p>We do not specifically market to children under 13.</p>

							<div class="divider divider-right"><a href="#" data-scrollto="#faqs-list"><i class="icon-chevron-up"></i></a></div>

							<h3 id="faq-11"> Fair Information Practices</h3>
							...
							<h3 id="faq-11"> In order to be in line with Fair Information Practices we will take the following responsive action, should a data breach occur:</h3>
							...
							<h3 id="faq-11">CAN SPAM Act</h3>
							<p>The CAN-SPAM Act is a law that sets the rules for commercial email, establishes requirements for commercial messages, gives recipients the right to have emails stopped from being sent to them, and spells out tough penalties for violations.</p>
                            
							<div class="divider divider-right"><a href="#" data-scrollto="#faqs-list"><i class="icon-chevron-up"></i></a></div>

							<h3 id="faq-11">We collect your email address in order to:</h3>
							<h3 id="faq-11">To be in accordance with CANSPAM we agree to the following:</h3>
							<ul>
							...
							<p><strong>If at any time you would like to unsubscribe from receiving future emails</strong>, you can email us at
and we will promptly remove you from ALL correspondence.</p>

                            
							<div class="divider divider-right "><a href="#" data-scrollto="#faqs-list"><i class="icon-chevron-up"></i></a></div>

							<h3 id="faq-11" class="nobottommargin">Contacting Us</h3>
							<p>If there are any questions regarding this privacy policy you may contact us using the information below.</p>
                            <p>
							    Rebelute.com</br>
								6370 STONERIDGE MALL ROAD Apt i211,</br>
								Pleasanton, CA 94588</br>
								USA </br>
								info@rebelute.com</br>
					...
					<div class="sidebar nobottommargin clearfix">
						<div class="sidebar-widgets-wrap">
							...
							<div class="widget widget_links clearfix">
								...
								<h4>Our Services</h4>
								<ul>
									<li><a href="<?php echo base_url();?>product-engineering"><div>Product Engineering</div></a></li>
									<li><a href="<?php echo base_url();?>digital-marketing"><div>Digital Marketing</div></a></li>
									<li><a href="<?php echo base_url();?>web-development-services"><div>Web Development Services</div></a></li>
									<li><a href="<?php echo base_url();?>mobile-development"><div>Mobile Development</div></a></li>
									<li><a href="<?php echo base_url();?>ui-ux-services"><div>UI/UX Services</div></a></li>
									<li><a href="<?php echo base_url();?>landing-page-services"><div>Landing Page Services</div></a></li>
							...
							<div class="widget clearfix">
								...
								<div id="post-list-footer">
									...
									<div class="spost clearfix">
										<div class="entry-image">
											<a href="#" class="nobg"><img src="<?php echo base_url();?>uploads/blogs/<?php echo $row_blog->blog_image;?>" alt=""></a>
										</div>
										<div class="entry-c">
											<div class="entry-title">
												<h4><a href="#"><?php echo $row_blog->title;?></a></h4>
											</div>
											<ul class="entry-meta">
								...
								<a href="https://www.facebook.com/rebelutedigital" class="social-icon si-colored si-small si-facebook" data-toggle="tooltip" data-placement="top" title="Facebook">
									<i class="icon-facebook"></i>
									<i class="icon-facebook"></i>
								</a>

								<a href="http://delicious.com/rebelute" class="social-icon si-colored si-small si-delicious" data-toggle="tooltip" data-placement="top" title="Delicious">
								...
								<a href="https://plus.google.com/u/0/105744246294021834866/posts" class="social-icon si-colored si-small si-gplus" data-toggle="tooltip" data-placement="top" title="Google Plus">
									<i class="icon-gplus"></i>
									<i class="icon-gplus"></i>
								</a>

								<a href="http://www.stumbleupon.com/stumbler/rebelute" class="social-icon si-colored si-small si-stumbleupon" data-toggle="tooltip" data-placement="top" title="Stumbleupon">
								...
								<a href="http://digg.com/u/rebelute" class="social-icon si-colored si-small si-digg" data-toggle="tooltip" data-placement="top" title="Digg">
									<i class="icon-digg"></i>
									<i class="icon-digg"></i>
								</a>
								...
								<a href="https://dribbble.com/rebelute" class="social-icon si-colored si-small si-dribbble" data-toggle="tooltip" data-placement="top" title="Dribbble">
									<i class="icon-dribbble"></i>
									<i class="icon-dribbble"></i>
								</a>

								<a href="https://www.flickr.com/people/141381656@N07/" class="social-icon si-colored si-small si-flickr" data-toggle="tooltip" data-placement="top" title="Flickr">
									<i class="icon-flickr"></i>
									<i class="icon-flickr"></i>
								</a>

								<a href="https://www.linkedin.com/company/rebelute" class="social-icon si-colored si-small si-linkedin" data-toggle="tooltip" data-placement="top" title="Linked In">
								...
								<a href="https://twitter.com/rebelutedigital" class="social-icon si-colored si-small si-twitter" data-toggle="tooltip" data-placement="top" title="Twitter">
									<i class="icon-twitter"></i>
									<i class="icon-twitter"></i>
								</a>

								<a href="https://www.youtube.com/channel/UC-MH2owuZqGy5nL-G2mF5NA" class="social-icon si-colored si-small si-youtube" data-toggle="tooltip" data-placement="top" title="Youtube">
								...
								<a href="https://github.com/rebelute" class="social-icon si-colored si-small si-github" data-toggle="tooltip" data-placement="top" title="Github">
								...
								<a href="https://in.pinterest.com/rebelutedigital/" class="social-icon si-colored si-small si-pinterest" data-toggle="tooltip" data-placement="top" title="Pinterst">
