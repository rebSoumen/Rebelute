...
<body class="stretched no-transition">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Page Title
  ============================================= -->
	<section id="page-title" class="page-title-parallax page-title-dark page-title-left" style="padding: 285px 0; background-image: url('<?php echo base_url();?>assets/main_site/images/blog.jpg'); background-size: cover; background-position: center center;" data-stellar-background-ratio="0.2">
