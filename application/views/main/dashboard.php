...
<head>
	...
	<!-- Page Title Here -->
       <TITLE>Digital Marketing, web & Landing page Design Company- Rebelute Pune</TITLE>
       ...
       <META NAME="keywords" CONTENT="Digital Marketing Company in India, Digital Marketing Agency, Search Engine Optimization Services, UI UX Development Services in India, Mobile App Development India, Social Media Marketing Agency">
	   <META NAME="revisit-after" CONTENT="1 days">

         <meta property="og:locale" content="en_US" />
		<meta property="og:type" content="website" />
		<meta property="og:title" content="Rebelute Digital Solutions" />
		<meta property="og:description" content="Rebelute is best Digital marketing & Digital Solutions agency. web & Landing page Development Services, Social media and search engines Optimization company in Pune India." />
					...
					<div class="row clearfix">
						...
						<div class="col-lg-7">
							...
							<div style="position: relative; margin-top:60px;margin-bottom: -60px;" class="ohidden" data-height-lg="426" data-height-md="567" data-height-sm="470" data-height-xs="287" data-height-xxs="183">
								...
								<img src="<?php echo base_url();?>assets/main_site/images/main-fmobile.png" alt="Website Ideas" style="position: absolute; top: 0; left: 0;" data-animate="fadeInUp" data-delay="400">
...
<div class="heading-block center nomargin">
								<h3 style="line-height:1.1">Our Expertise</h3>
							</div>
						<div class="row topmargin-sm clearfix">

							<div class="col-md-4 bottommargin">
								<div class="center">
								<img src="<?php echo base_url();?>assets/main_site/images/strategy_homepage.png" alt="Digital  marketing strategy "/>	
							...
							<div class="col-md-4 bottommargin">
							<div class="center">
								<img src="<?php echo base_url();?>assets/main_site/images/creative_homepage.png" alt="Creative landing page development"/>
								<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
							...
							<div class="col-md-4 bottommargin">
							<div class="center">
								<img src="<?php echo base_url();?>assets/main_site/images/technology.png" alt="Mobile application development"/>	
								<div class="heading-block nobottomborder" style="margin-bottom: 15px;">
...
<a href="<?php echo base_url();?>product-engineering">
					<div class="col-md-3 col-sm-6 dark center paddinghomediv" style="background-color: #515875;">
						<div>
							...
							<h2 class="own-h2">Product Engineering</h2>
						</div>
					</div>
</a>
<a href="<?php echo base_url();?>digital-marketing ">
					<div class="col-md-3 col-sm-6  dark center paddinghomediv" style="background-color: #576F9E;">
						<div>
							...
							<div class="counter counter-lined"></div>
							<h2 class="own-h2">Digital Marketing</h2>
						</div>
					</div>
</a>
<a href="<?php echo base_url();?>ui-ux-services">
					<div class="col-md-3 col-sm-6 dark center paddinghomediv" style="background-color: #6697B9;">
						<div>
							...
							<div class="counter counter-lined"></div>
							<h2 class="own-h2">UI/UX</h2>
						</div>
					</div>
</a>
<a href="<?php echo base_url();?>mobile-app-development">
					<div class="col-md-3 col-sm-6 dark center paddinghomediv" style="background-color: #88C3D8;">
						<div>
							...
							<div class="counter counter-lined"></div>
							<h2 class="own-h2">Mobile App Development</h2>
						</div>
					</div>
</a>					
...
<div class="illustration">
 ...
 <a class="button" xmlns:xlink="http://rebelute.com/digital-marketing" xlink:href="http://rebelute.com/digital-marketing" target="_blank">
  ...
  </g><g class="question-mark" id="questionMark1"><text x="150" y="100" text-anchor="middle" dy="7" font-size="20">Brand</text>
...
<div class="heading-block center">
					...
					<div class="oc-item"><img src="<?php echo base_url();?>assets/main_site/images/clients/12.png" alt="CHERRY CREEK"></div>
					<div class="oc-item"><img src="<?php echo base_url();?>assets/main_site/images/clients/13.png" alt="CHERRY CREEK"></div>
				...
				<div class="row nomargin clearfix">
					...
					<div class="col-sm-6 col-padding" data-height-lg="565" data-height-md="565" data-height-sm="565" data-height-xs="565" data-height-xxs="565">
						...
						<form action="<?php echo base_url();?>home/save_serviceInfoHomePage" method="post" class="clearfix" style="max-width: 300px;" onsubmit="return validate();">
							<input type="hidden" value="home_page" name="page_name"/>
							<div class="col_full">
		...
		<script type="text/javascript">
			...
			function validate()
			{
				...
				if(captcha!="" && captcha==captcha_real)
				{
					del_captcha = true;
				}
				if(del_captcha==false)
				{
					alert('Reload The Page Get Valid Captcha');
					return false;
				}
			}
