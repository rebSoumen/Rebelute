...
<body id="page-top" class="index">
	...
	<div class="col-md-12">
        <div class="phone-info whitebg">
		<span style="float:right;color: #fff;font-weight: 600;">
		<span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> : <span class="rTapNumber136291" style="visibility: visible; color: yellow; font-size: 17px !important;"> (+91) 9665137683, 020-65618181</span>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
				...
				<a href="http://rebelute.com/" target="_blank">
 ...
 <!-- RecentProjects -->  
            ...
            <div class="row">
				...
				<h5><span class="Grey">RECENT</span> <span class="red">PROJECTS</span></h5>
					<h5><p class="text-center text-capitalize small font1">Here are a few mobile applications we recently completed. To view a demo of these projects and others, please call us at (+91) 9665137683 or send a message to schedule a meeting.</p>
					<br>
				   <br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center font1">
                    <h2 style="font-size: 30px;margin-bottom: 22px;color:yellow !important">CALL US: +91 9665137683, 020 65618181, 080 49542499</span></h2>
                 
                </div>
				<div class="row">
					<div class="col-lg-12">
						<p class="text-center font1" style="color:white !important">Or send us a message and we’ll follow up with you promptly! Our office is located in the <br> California, so if you’d like to come by for a demo, we’d be happy to set up a meeting.</p><br/>
					</div>
				 </div>
				 <br/><br/>
				 <div class="col-lg-12 text-center font1" style="margin-bottom:-7px;">
                    <h2 style="font-size: 30px;margin-bottom: 22px;color:yellow !important">REACH US</h2>
                 
                </div>
				<br>
				<div class="row">
					<div class="col-lg-12">
						<p class="text-center font1 col-md-6" style="color:white !important">
...
Wadgaon Sheri, Pune - 411014.
						...
						<p class="text-center font1 col-md-6" style="color:white !important">
						218, The Arcade, Brigade Metropolis,<br/>
...
Bangalore - 560048, Karnataka.
    ...
    <div class="col-md-4 text-center font">
     ...
     <div class="col-md-4 text-center font">
     <h5><a href="http://rebelute.com/" target="_blank">www.rebelute.com</a></h5>
     </div>
     <div class="col-md-4 text-center font">
     <h5>Contact us: (+91) 9665137683, 020-65618181</h5>
     </div>
